  ...
  const programs = [
    {
      ...
      duration: "6 Months",
      description:
        "Comprehensive training to develop positive and proactive mindsets. Twelve logical, practical lessons that translate into tangible results in all aspects of life, work, relationships, confidence and leadership.",
    ...
    },
    {
      ...
      duration: "3 Months",
      description:
        "A condensed version of our 6-month flagship programme, intensifying the learning and increasing impact over a shorter period of time.",
      color: "text-gif-cyan",
    ...
    },
    {
      ...
      duration: "8 Weeks",
      description:
        "A transformative journey designed to ignite the inner entrepreneur, rewire thinking, and empower participants to turn ideas into impactful ventures.",
    ...
    },
    {
      ...
      duration: "3 Months",
      description:
        "Intensive programme to empower, inspire and enable changed thinking and beliefs for improved personal outcomes. Specifically designed for current and former prison members.",
      color: "text-gif-lime",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-4xl sm:text-5xl font-display font-bold mt-6 mb-4">
            Innovative{" "}
            <span className="gradient-energy text-gradient">Mindset</span>{" "}
            Programmes
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We offer transformative programmes designed to unlock potential and
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {programs.map((program, index) => (
            ...
            >
              <CardHeader>
                <div
                  className={`w-16 h-16 rounded-2xl ${program.bgColor} flex items-center justify-center mb-4`}
                >
                  <program.icon className={`h-8 w-8 ${program.color}`} />
                </div>
                <div className="mb-2">
                  <span
                    className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${program.bgColor} ${program.color}`}
                  >
                    {program.duration}
                  </span>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                In partnership with Empowered Growth Marketing, we're launching
                an innovative programme designed for companies. This
                revenue-generating initiative combines mindset transformation
                with business growth strategies.
              </p>
              <Button
                style={{ backgroundColor: "#2D80C1" }}
                asChild
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 group"
              >
                <a
                  href="https://think-global.io/"
                  target="_blank"
