...
export const GetInvolved = () => {
  ...
  return (
    <div className="bg-background">
      ...
      <section id="become-donor" className="py-24 bg-gradient-to-br from-gif-orange/10 via-background to-gif-yellow/10 relative overflow-hidden">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="border-2 hover:border-gif-cyan/50 hover:bg-gif-cyan/5 transition-all">
                <CardHeader>
                  <div className="w-12 h-12 rounded-xl bg-gif-cyan/10 flex items-center justify-center mb-3">
                    <Heart className="h-6 w-6 text-gif-cyan" />
                  </div>
                  <CardTitle className="text-lg">Tutoring & Mentoring</CardTitle>
                  <CardDescription>Guide and inspire young people on their journey</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="border-2 hover:border-gif-cyan/50 hover:bg-gif-cyan/5 transition-all">
                <CardHeader>
                  <div className="w-12 h-12 rounded-xl bg-gif-cyan/10 flex items-center justify-center mb-3">
                    <MapPin className="h-6 w-6 text-gif-cyan" />
                  </div>
                  <CardTitle className="text-lg">Community Empowerment</CardTitle>
                  <CardDescription>Engage directly with communities we serve</CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="border-2 hover:border-gif-cyan/50 hover:bg-gif-cyan/5 transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Administrative Help</CardTitle>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {["Event Support", "Tutoring & Mentoring", "Community Empowerment", "Administrative Help"].map((interest) => (
